...
export const homeScreen = [
  ...
  },
  {
    healthcare: {
      ...
      title:
        "Healthcare Marketing that Resonates with Your Audience",
      description: [
...
export const companiesPage = [
  {
    hero: {
      ...
      title:
        "Go Beyond Traditional Healthcare Marketing Platforms",
      description:
  ...
  },
  {
    healthcare: {
      ...
      title:
        "Accelerate Your Healthcare Marketing Strategy",
      description: [
...
export const patientScreen = [
  {
    hero: {
      ...
      title:
        "Where Patients Connect with Newfound Earning Opportunities",
      description:
        "Overcome the challenges and legalities of direct-to-patient marketing with Patients Influence.",
      buttons: 1,
      primaryBtn: "Get started",
