...
const Footer = () => {
  return (
      <footer className='bg-gray-200 pb-[40px] pt-[60px] lg:pb-[60px] lg:pt-[108px]'>
          <div className='container flex flex-col justify-center items-center'>
              ...
              <p className='max-w-[900px] text-center text-lg text-primaryBlue mt-[30px]'>
                  Build trust and authenticity by connecting with highly-relevant patient
              ...
              <p className='text-sm md:text-base text-center text-primaryBlue'>
                  ...
                  <a href='#' className='font-semibold text-[#448DC9]'>
